...
@section('content')
    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="">{{ trans('app.Amana_Advertisment') }}</li>
                {{--  @if(isset($find))
    ...
    <div class="panel panel-flat">
        ...
        @endif
            ...
            <form action="{{ isset($find) ? url('admin/edit_amana_advertisment/'.$find->id) : url('admin/add_amana_advertisment') }}" method="post" class="form-horizontal" enctype='multipart/form-data' style="margin:20px;">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        @if(isset($find))
                            <img src="{{ url('Admin/images/amana_advertisment/'.$find->image) }}" name="df_image" style="width:80px;height:80px;"/>
