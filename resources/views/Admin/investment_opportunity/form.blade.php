...
@section('content')
    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="">{{ trans('app.Investment_Opportunity') }}</li>
                {{--  @if(isset($find))
    ...
    <div class="panel panel-flat">
        ...
        @endif
            ...
            <form action="{{ isset($find) ? url('admin/edit_investment_opportunity/'.$find->id) : url('admin/add_investment_opportunity') }}" method="post" class="form-horizontal" enctype='multipart/form-data' style="margin:20px;">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        @if(isset($find))
                            <img src="{{ url('Admin/images/investment_opportunity/'.$find->image) }}" name="df_image" style="width:80px;height:80px;"/>
