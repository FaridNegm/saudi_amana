...
Route::post('admin/add_prince_comments' , 'Admin\PrinceCommentsController@store');
Route::post('admin/add_gayza_comments' , 'Admin\GayzaCommentsController@store');
Route::post('admin/add_ameen_comments' , 'Admin\AmeenCommentsController@store');
Route::post('admin/add_amana_comments' , 'Admin\HonestCommentsController@store');
Route::post('admin/add_gate_comments' , 'Admin\GateCommentsController@store');
