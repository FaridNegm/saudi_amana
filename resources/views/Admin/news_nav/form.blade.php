...
@section('content')
    ...
    <div class="page-header page-header-default">
        ...
        <div class="breadcrumb-line">
            <ul class="breadcrumb">
                ...
                <li class="">{{ trans('app.News_navbar') }}</li>
                {{--  @if(isset($find))
    ...
    <div class="panel panel-flat">
        ...
        @endif
            ...
            <form action="{{ isset($find) ? url('admin/edit_news_nav/'.$find->id) : url('admin/add_news_nav') }}" method="post" class="form-horizontal" enctype='multipart/form-data' style="margin:20px;">
                @csrf

                <div class="form-group">
                    <label class="control-label col-sm-3" for="title">{{ trans('app.Title') }}</label>
                    <div class="col-md-9">
                        <input id="title" type="text" class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="name" value="{{ isset($find->name) ? $find->name : ''}}"  placeholder="{{ trans('app.Title') }}">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="title">{{ trans('app.Url') }}</label>
                    <div class="col-md-9">
                ...
                {{-- <div class="form-group">
                    ...
                    <div class="col-md-9">
                        ...
                        @if(isset($find))
                            <img src="{{ url('Admin/images/news_nav/'.$find->image) }}" name="df_image" style="width:80px;height:80px;"/>
