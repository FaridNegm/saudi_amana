        ...
        @endif
            ...
            <form action="{{ isset($find) ? url('admin/edit_setting/'.$find->id) : url('admin/add_setting') }}" method="post" class="form-horizontal" enctype='multipart/form-data' style="margin:20px;">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                            <label class="control-label col-sm-3" for="number">الرقم الموحد</label>
                            <div class="col-md-9">
                                <input id="number" type="text" class="form-control{{ $errors->has('number') ? ' is-invalid' : '' }}" name="number" value="{{ isset($find->number) ? $find->number : ''}}"  placeholder="الرقم الموحد">
                        ...
                        <div class="form-group">
                                <label class="control-label col-sm-3" for="fax">فاكس</label>
                                <div class="col-md-9">
                                    <input id="fax" type="text" class="form-control{{ $errors->has('fax') ? ' is-invalid' : '' }}" name="fax" value="{{ isset($find->fax) ? $find->fax : ''}}"  placeholder="فاكس">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="video">الفديو</label>
                    <div class="col-md-9">
                        <textarea id="video" class="form-control{{ $errors->has('video') ? ' is-invalid' : '' }}" name="video" rows="5" placeholder="الفديو" >{{ isset($find->video) ? $find->video : ''}}</textarea>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="add1">الإعلان الأول</label>
                    <div class="col-md-9">
                        <input type="file" class="file-input" data-show-caption="false" data-show-upload="false" data-browse-class="btn btn-primary" data-remove-class="btn btn-default" value="{{ isset($find) ? $find->add1 : '' }}" name="add1">


                        @if(isset($find))
                            <img src="{{ url('Admin/images/setting/'.$find->add1) }}" name="df_image1" style="width:80px;height:80px;"/>
                            <input type="hidden" name="df_image1" value="{{ $find->add1 }}" />
                        @endif
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="add2">الإعلان الثاني</label>
                    <div class="col-md-9">
                        <input type="file" class="file-input" data-show-caption="false" data-show-upload="false" data-browse-class="btn btn-primary" data-remove-class="btn btn-default" value="{{ isset($find) ? $find->add2 : '' }}" name="add2">


                        @if(isset($find))
                            <img src="{{ url('Admin/images/setting/'.$find->add2) }}" name="df_image2" style="width:80px;height:80px;"/>
                            <input type="hidden" name="df_image2" value="{{ $find->add2 }}" />
                        @endif
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="add3">الإعلان الثالث</label>
                    <div class="col-md-9">
                        <input type="file" class="file-input" data-show-caption="false" data-show-upload="false" data-browse-class="btn btn-primary" data-remove-class="btn btn-default" value="{{ isset($find) ? $find->add3 : '' }}" name="add3">


                        @if(isset($find))
                            <img src="{{ url('Admin/images/setting/'.$find->add3) }}" name="df_image3" style="width:80px;height:80px;"/>
                            <input type="hidden" name="df_image3" value="{{ $find->add3 }}" />
                        @endif

                        @if ($errors->has('add3'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('add3') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="add4">الإعلان الرابع</label>
                    <div class="col-md-9">
                        <input type="file" class="file-input" data-show-caption="false" data-show-upload="false" data-browse-class="btn btn-primary" data-remove-class="btn btn-default" value="{{ isset($find) ? $find->add4 : '' }}" name="add4">


                        @if(isset($find))
                            <img src="{{ url('Admin/images/setting/'.$find->add4) }}" name="df_image4" style="width:80px;height:80px;"/>
                            <input type="hidden" name="df_image4" value="{{ $find->add4 }}" />
                        @endif

                        @if ($errors->has('add4'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('add4') }}</strong>
                            </span>
                        @endif
                    </div>
                </div>
